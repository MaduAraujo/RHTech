...
import { styles, Colors } from '../styles/DocumentNewChecklistScreenStyle';
...
const DocumentNewChecklistScreen = () => {
  ...
  const initialDocuments = DOCUMENT_LIST.map((docName, index) => ({
    id: `${index}`,
    name: docName,
    status: 'Pendente',
    conclusionDate: null,
    ...
    return (
      <View style={styles.docItem}>
        ...
        {isCompleted && item.conclusionDate && (
          <Text style={styles.dateText}>Concluído em: {item.conclusionDate}</Text>
        )}
    ...
    <View style={styles.container}>
      <View style={styles.header}>
        ...
        <View>
          ...
          <Text style={styles.subtitle}>{collaborator.nomeCompleto}</Text>
        </View>
      </View>
      <FlatList
        data={documents}
...
export default DocumentNewChecklistScreen;